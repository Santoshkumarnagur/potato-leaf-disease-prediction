...
def main():
    ...
    try:
                    ...
                    if "healthy" in predicted_class.lower():
                        st.markdown("""
                            <div class="stCard">
                                ...
                                <div class="timeline">
                                    <div class="timeline-item">▶ Continue regular maintenance schedule</div>
                                    <div class="timeline-item">▶ Monitor water and nutrient levels</div>
                                    <div class="timeline-item">▶ Maintain current environmental conditions</div>
                                    <div class="timeline-item">▶ Schedule next inspection in 7 days</div>
                                </div>
                            </div>
                        """, unsafe_allow_html=True)
                    else:
                        st.markdown("""
                            <div class="stCard">
                                <h3 style="color: #dc3545;">⚠ Disease Management Protocol</h3>
                                <div class="timeline">
        ...
        st.error("⚠ System Error: Please ensure all model files are properly configured.")
